 ...
 * @Modified By:
 */
case class DistributedGlobalArgs(coreNum: Int = Runtime.getRuntime().availableProcessors(),
                                 importerStatics : DistributedImporterStatics,
                                 estNodeCount: Long, estRelCount: Long,
                                 nodeDB: PandaDistributeKVAPI,
                                 relationDB: PandaDistributeKVAPI, inrelationDB: PandaDistributeKVAPI, outRelationDB: PandaDistributeKVAPI)

case class DistributedImporterStatics() {
