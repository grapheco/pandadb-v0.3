...
//import cn.pandadb.kernel.kv.{ByteUtils, GraphFacadeWithPPD, PandaPropertyGraphScanImpl}
...
//            val degree1 = graphStore.findToNodes(id) // 57ms
...
//          var count1 = 0
//          var count2 = 0
//          val degree1 = graphStore.findToNodes(id)
...
//                .toList
//                .map {
//                  graphStore.findToNodes(_).length
//                }
//                .sum)
//          }
//        )
...
//      val iter = graphStore.findOutRelations(chooseId, edgeType)
//
//      while (iter.hasNext) {
//        val res = iter.next()
