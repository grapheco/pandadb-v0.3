...
//    Profiler.timing({
//      println("(3543605)-[]->(*)")
//      val res = graphFacade._paths(NodeId(3543605),SemanticDirection.OUTGOING).take(limit)
//      println(res.length)
//    })
//    Profiler.timing({
//      println("(3543605)<-[]-(*)")
//      val res = graphFacade._paths(NodeId(3543605),SemanticDirection.INCOMING).take(limit)
//      println(res.length)
//    })
//    Profiler.timing({
//      println("(1298177)-[:type7]->(*)")
//      val res = graphFacade
//        ._paths(NodeId(1298177),
