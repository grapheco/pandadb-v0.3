...
//import java.io.File
//
//import cn.pandadb.kernel.kv.relation.{NoRelationGetException, RelationPropertyStore}
...
//  var relationStore: RelationPropertyStore = null
//  var db: RocksDB = null
//  @Before
//  def init(): Unit = {
...
//    relationStore = new RelationPropertyStore(db)
//
