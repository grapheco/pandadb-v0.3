...
object RocksDBStorage {
  ...
  val rocksdbConfigFile = new File("/home/pandadb/rocksdb.conf")
  val builder = new RocksDBConfigBuilder(rocksdbConfigFile)
...
//    }
    ...
    new RocksDBStorage(RocksDB.open(builder.getOptions(), path))
  }
}
